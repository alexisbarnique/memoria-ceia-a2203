...
\midrule
\textsc{transferencia}  & 1.000 & 1.000 & 1.000 & 325 \\
\textsc{consulta\_saldo} & 1.000 & 1.000 & 1.000 & 305 \\
\textsc{cancelar}       & 1.000 & 1.000 & 1.000 & 290 \\
\midrule
\textit{Macro avg}      & 1.000 & 1.000 & 1.000 & 920 \\
\textit{Weighted avg}   & 1.000 & 1.000 & 1.000 & 920 \\
\midrule
...
\midrule
\textit{Macro avg}      & 1.0000 & 0.9034 & 0.9491 & 4414 \\
\textit{Weighted avg}   & 1.0000 & 0.8965 & 0.9453 & 4414 \\
\midrule
...
\multirow{4}{*}{\textit{Strict}}
  ...
  \cmidrule(l){2-5}
  & \textit{Macro avg} & 1.0000 & 0.8812 & 0.9369 \\
\midrule
...
Las figuras~\ref{fig:app-idle} a~\ref{fig:app-processing} ilustran los estados de la interfaz durante el flujo de interacción del protocolo de evaluación.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.35\textwidth]{./Figures/screenshots/home-app-base.PNG}
\caption[Pantalla principal de la app base en estado idle]{Pantalla principal de la app base en estado \texttt{idle}. El botón azul con ícono de micrófono indica que el sistema está listo para recibir un comando de voz.}
\label{fig:app-idle}
\end{figure}
...
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/solicitud-permiso-microfono.PNG}
\caption[Solicitud de permiso de acceso al micrófono]{Solicitud de permiso de acceso al micrófono (\texttt{NSMicrophone\allowbreak{}UsageDescription}), presentada la primera vez que el usuario activa la escucha.}
\label{fig:permiso-mic}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\textwidth}
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/solicitud-permiso-reconocimiento-voz.PNG}
\caption[Solicitud de permiso de reconocimiento de voz]{Solicitud de permiso de reconocimiento de voz (\texttt{NSSpeech\allowbreak{}Recognition\allowbreak{}Usage\allowbreak{}Description}).}
...
\begin{minipage}[t]{0.45\textwidth}
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/transcripcion-dictado.PNG}
\caption[Estado listening: transcripción en tiempo real]{Estado \texttt{listening}: el botón muta a rojo con animación de pulsación. La transcripción parcial se muestra en tiempo real.}
\label{fig:app-listening}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\textwidth}
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/procesamiento.PNG}
\caption[Estado processing: inferencia de modelos Core ML]{Estado \texttt{processing}: el botón se muestra gris con ícono de cerebro mientras los modelos Core~ML ejecutan la inferencia.}
\label{fig:app-processing}
\end{minipage}
\end{figure}

Las figuras~\ref{fig:confirm-transferencia} a~\ref{fig:confirm-saldo} muestran las pantallas de confirmación para cada tipo de intención detectada.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.40\textwidth]{./Figures/screenshots/intencion-confirmacion-transferencia.PNG}
...
\begin{minipage}[t]{0.45\textwidth}
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/intencion-consulta-saldo.PNG}
...
\begin{minipage}[t]{0.45\textwidth}
\centering
\includegraphics[width=0.78\textwidth]{./Figures/screenshots/intencion-cancelar.PNG}
...
de 0.9369, que si bien es inferior al del clasificador ---lo que es esperable dado que la extracción de entidades es intrínsecamente una tarea más compleja que la clasificación de texto--- resulta suficiente para la prueba de concepto
propuesta.

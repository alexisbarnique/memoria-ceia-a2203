...
La transición entre el entorno probabilístico inherente a los modelos de machine learning y el rigor determinista exigido por los sistemas financieros requiere de una capa de abstracción robusta. Para resolver este paradigma, se estructuraron los datos resultantes de la inferencia algorítmica utilizando estructuras de valor \textit{struct} en Swift  \citep{apple2026swiftlanguage}. El uso de \textit{structs} garantizó la inmutabilidad de la información una vez extraída y procesada, previniendo alteraciones accidentales de las variables en la memoria durante el ciclo de vida de la transacción.

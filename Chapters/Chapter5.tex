...
\item La metodología CRISP-DM resultó adecuada para estructurar las fases del proyecto, permitiendo iterar entre la comprensión del dominio financiero, la generación del \textit{dataset} sintético, el entrenamiento de los modelos y la evaluación de resultados.
\end{itemize}

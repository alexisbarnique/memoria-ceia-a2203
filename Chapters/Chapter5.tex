...
Los resultados obtenidos validan que la convergencia entre los \textit{frameworks} nativos de Apple (Speech, Core~ML, Natural\-Language) y las técnicas de procesamiento de lenguaje natural permite construir soluciones de voz robustas, privadas y de baja latencia para el dominio financiero, sin dependencia de servicios en la nube.

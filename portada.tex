...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Sistema de transacciones financieras por voz en dispositivos móviles iOS} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Alexis Geraldine Barniquez Piñero} \\[1cm]
        ...
        \textbf{Director:} Ing. Sergio Ivaldi} \\[1cm]
        ...
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Lic. Juan Manuel Calabia (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Lic. Luciano Adassus (FIUBA)} \\[2cm]
